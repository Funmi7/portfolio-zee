        ...
        <section className="mt-24 transition ease-in-out delay-150">
          ...
          <div className="flex items-center justify-between mt-10 gap-12">
            <div className="w-1/2">
              ...
              <p>
                ...
                designer with a keen eye for detail and a drive for excellence.
                I specialize in creating interactive, responsive, and visually
          ...
          <div className="flex items-center justify-between mt-10 gap-12">
            ...
            <div className="w-1/2">
              ...
              <p>
                One of the most significant milestones in my career was my role
                in the HNG Internship 11 program. As a team lead, I was
                responsible for overseeing a group of talented interns, guiding
                them through complex projects, and ensuring the successful
                completion of our objectives. My contributions included:
              </p>
            </div>
          </div>
        </section>
